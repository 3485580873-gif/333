...
(function () {
    ...
    function openCompanionPage(opts) {
        ...
        // 隐藏header（backdrop-filter会导致z-index失效，必须物理隐藏）
        ['.header', '.main-chat-area', '.input-area-wrapper'].forEach(function(sel) {
            document.querySelectorAll(sel).forEach(function(el) {
                el.setAttribute('data-ch', el.style.display || '');
    ...
    function closeCompanionPage(opts) {
        ...
        document.querySelectorAll('[data-ch]').forEach(function(el) {
            el.style.display = el.getAttribute('data-ch') || '';
