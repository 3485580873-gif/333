...
if (momentsAutoPostMinSlider) {
    ...
    momentsAutoPostMinSlider.addEventListener('change', () => { throttledSaveData(); if (typeof manageMomentsAutoPostTimer === 'function') manageMomentsAutoPostTimer(); });
}
if (momentsAutoPostMinUnit) {
    momentsAutoPostMinUnit.addEventListener('change', (e) => {
        ...
        throttledSaveData(); if (typeof manageMomentsAutoPostTimer === 'function') manageMomentsAutoPostTimer();
    });
}
...
if (momentsAutoPostMaxSlider) {
    ...
    momentsAutoPostMaxSlider.addEventListener('change', () => { throttledSaveData(); if (typeof manageMomentsAutoPostTimer === 'function') manageMomentsAutoPostTimer(); });
}
